...
class DigitalDetoxChangeBottomFragment(val to_do_work: (String) -> Unit): BottomSheetDialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        head.text=requireContext().getString(R.string.digital_detox_change)
        var to_do=""
